                  ...
                  <i className="fa-solid fa-cake-candles">
                         <span className="position-absolute top-25 start-100 translate-middle p-2 bg-danger border border-light rounded-circle">
                           <span className="visually-hidden">New alerts</span>
                             {(birthDay.length === 0)?(<Fragment></Fragment>):(<div className='lenght'> {lenght}</div>)} 
                             </span> 
                        </i>
                  </button>
                  ...
                  <div className="modal-dialog">
                    <div className="modal-content">
                      <div className="modal-header">
                        <h1 className="modal-title fs-5" id="exampleModalLabel">`today Birthday {birthDay.name}` </h1>
                      ...
                      <div className="modal-footer">
                            <button className='btn btn-danger'  data-bs-dismiss="modal" onClick={clearAllRecords}>Clear All</button>
